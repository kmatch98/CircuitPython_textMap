...
textBoxes.append(
    textBox("", DISPLAY_WIDTH, DISPLAY_HEIGHT, 0x000000, 0x443344, fontList[0])
)
print("Memory free: {}".format(gc.mem_free()))
...
stringList = []
stringList.append(
    "Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box. Full Screen Size: This is a stationary box, not a stationery box."
)
stringList.append("Helvetica Bold 16 font - Transparent background color")
stringList.append("Vera Sans 24 font - this is a longer line that is wrapping around")
stringList.append(
    "Vera Sans 16 font - how much text will this hold but it will not print text that goes outside the box but it will cut it off at the bottom if it is too large."
)

for i, box in enumerate(textBoxes):
    tileGridList.append(
        displayio.TileGrid(box.bitmap, pixel_shader=box.palette, x=x[i], y=y[i])
    )
